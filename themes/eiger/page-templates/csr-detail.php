...
<?php if (have_posts()) : while ( have_posts() ) : the_post(); ?>
               ...
               <section class="wow fadeIn cover-background background-position-top" style="background-image:url('<?php the_field( 'csr_content_cover' ); ?>');">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 breadcrumb alt-font text-small">
                        <!-- breadcrumb -->
                        <ul>
                            <li><a href="https://eiger.wit.id/" class="text-medium-gray">Home</a></li>
                            <li><a href="https://eiger.wit.id/news" class="text-medium-gray">News</a></li>
                            <li class="text-medium-gray"><?php the_title(); ?><a href="#"></a></li>
                        </ul>
                        <!-- end breadcrumb -->
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-lg-10 mx-auto text-center last-paragraph-no-margin">
                        <h5 class="alt-font text-extra-dark-gray font-weight-600 mb-0"><?php the_field( 'csr_content_subtitle' ); ?><br><br></h5>
                        <p><?php the_field( 'csr_content_desc' ); ?><br><br></p>
                    </div>
                </div>
                <div class="row">
                    ...
                    <?php while ( have_rows( 'highlight' ) ) : the_row(); ?>
                        <div class="col-12 col-lg-6 pl-0 md-no-padding-lr md-margin-30px-bottom text-center last-paragraph-no-margin">
                            <div class="bg-light-gray padding-50px-all md-padding-25px-all">
                                ...
                                <?php if ( get_sub_field( 'highlight_cover' ) ) { ?>
                                    <img src="<?php the_sub_field( 'highlight_cover' ); ?>" alt="" class="width-100 margin-30px-tb">
                                <?php } ?>
